...
# @app.get("/")
# def root():
#     return {"message": "AstroEvent AI backend is running"}
...
# @app.get("/api/weather")
# def weather():
#     return get_weather(18.5204, 73.8567)

# app.include_router(sun_router, prefix="/api")
# app.include_router(planets_router, prefix="/api")
# app.include_router(meteor_showers_router, prefix="/api")
# app.include_router(deep_sky_router,prefix="/api")
# app.include_router(astro_weather_router,prefix="/api")
# app.include_router(astronomical_events_router,prefix="/api")
# app.include_router(ai_recommendation_router,prefix="/api")
# app.include_router(observation_router,prefix="/api")
# app.include_router(constellations_router,prefix="/api")
